...
const { chromium } = require('/home/user/Wiederholung/plan/werkzeuge/pruefstand/node_modules/playwright');
const fs = require('fs');
const fj = JSON.parse(fs.readFileSync('/home/user/Wiederholung/firebase.json', 'utf8'));
