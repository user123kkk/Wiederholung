...
| G-002 | Rechtsseiten ignorieren helles Thema: CSP blockiert Kopfskript → Skript byte-gleich zu `index.html` machen (`#0e0e12`→`#111010`) | TECHNIK-1 | hoch | A | H | P1 | offen |
| G-003 | „not-found" beim Speichern schreibt alle Bereiche ohne merge neu: Teilen/Lehrer/geführt weg, Gelöschtes kommt zurück | DATEN-1, REGELN-1 | **kritisch** | A | O | P2 | offen |
...
| G-006 | Geteilte Sätze verwaisen und überleben „Konto löschen" (Regel `list` nach Besitzer + Löschen über Besitzer + Reihenfolge) | REGELN-3 | hoch | A | O | P2 | offen |
| G-007 | Serie bleibt bei 121 Tagen stehen (Protokoll 120 Tage, Sockel wird nicht nachgezogen) | LERNEN-1 | hoch | A¹ | O | P5 | offen |
| G-008 | Prüfskript in den Veröffentlichen-Knopf und die `.bat` einbauen (bricht vor dem Deploy ab) | TECHNIK-2, -14 | hoch | A | H | P1 | offen |
...
|---|---|---|---|---|---|---|
| G-010 | Firebase-Sprache nicht gesetzt → englische Mails/Seiten: `auth.languageCode = "de"` | KONTO-1 | A | H | P6 | offen |
| G-011 | Konto löschen: offline sperren, Zeitlimit für die Löschschritte | KONTO-2 | A | S | P7 | offen |
| G-012 | „Passwort vergessen": vorsichtiger Erfolgstext (Enumeration) | KONTO-3 | A | H | P6 | offen |
| G-013 | Fehlende Auth-Fehlercodes in Worten + Leerfeld-Prüfung bei „Link zusenden" | KONTO-4 | A | S | P6 | offen |
| G-014 | Stimmen im Board ohne eigene Stimme ±1 manipulierbar → Regel mit `existsAfter` | REGELN-2 | A | O | P8 | offen |
...
| G-017 | Code erzeugen: Code steht am Bereich, bevor er gespeichert ist; keine 1-MiB-Prüfung; kein Zeitlimit | REGELN-7, LERNEN-7, DATEN-7 | A | S | P2 | offen |
| G-018 | „Teilen beenden"/Bereich löschen scheitert still, Code bleibt lesbar → erst Cloud löschen, dann lokal | DATEN-6 | A | S | P2 | offen |
| G-019 | Fremde Sätze können über `quelleId: null` doch Bilder vom Absender-Server laden | DATEN-4 | A | S | P3 | offen |
...
| G-034 | Veröffentlichen lädt `*.zip` mit hoch; `.bat` deployt ungeprüften Arbeitsordner | TECHNIK-9 | A | H | P1 | offen |
...
| G-038 | „Kostenlos." steht noch unter „Plan speichern" | EINSTIEG-2 | A | H | P14 | offen |
...
| G-043 | „Bewegung reduzieren": Verzögerungen außerhalb des Einstiegs bleiben (Rundenende-Knöpfe 1,3 s unsichtbar) | EINSTIEG-8 | A | H | P12 | offen |
...
| G-052 | Fehlertexte mit Ausweg (Google-Konto? Passwort vergessen?) | KONTO-13 | A | H | P6 | offen |
...
| G-055 | Regeltest um E01–E20/P1–P6 erweitern, Kopfzahl, Linux-Anleitung | REGELN-8 | A | S | P8 | offen |
| G-056 | `normCard` deckelt `stufe` nicht nach oben → Import-Stapel scheitert | REGELN-9 | A | H | P3 | offen |
...
| G-071 | Workflow: Werkzeugversion festlegen, `trap`, `permissions: read` | TECHNIK-14 | A | H | P1 | offen |
| G-072 | Zwei tote CSP-Hashes (+ `csp-build` mitzählen) | TECHNIK-16 | A | H | P1 | offen |
| G-073 | Rechtsseiten: Querverweis Datenschutz → Impressum | TECHNIK-18 | A | H | P1 | offen |
...
| G-078 | Kommentar zur Lektions-Schwelle nennt Stufe 2 statt 1 | LERNEN-12 | A | H | P5 | offen |
...
| G-084 | Google-Knopf sagt „anmelden", wo ein Konto angelegt wird | EINSTIEG-13 | A | H | P14 | offen |
