...
| ~~14~~ | ~~Analytics – Ja oder Nein?~~ | **Entfernt 24.09.2026 (v3.17.23).** Erst Ja (v3.17.0, nie eingeschaltet), nach der Rechtsprüfung (PostHog-Vertrag hätte eigens unterschrieben werden müssen, offene Frage § 25 TDDDG) auf Betreiber-Wunsch komplett entfernt: „jede spur“. Code, Schalter, CSP, Datenschutz-Abschnitt weg; nie Daten gesendet. Nicht wieder einbauen ohne neue Entscheidung. Details: [`analytics/GERUEST.md`](analytics/GERUEST.md). |
...
Hinzufügen-Blatt, sonst wie unten.

**Davor (26.09.2026, mittags): v3.17.35 auf `main`; live ist 3.17.34.**
Großplan Runde 5 fertig: G-031, G-032, G-033, G-063, G-064 (Barrierefreiheit);
davor Runde 4: G-023, G-024, G-025, G-026, G-060 (Fortschritt).
`veroeffentlichen.bat` repariert (Windows-Zeilenenden, `call firebase`).
Regeln: Betreiber hat den Stand von `main` eingesetzt (26.09.).
Weiter mit Runde 6 nach `plan/grossplan/AUFTRAG.md` (Routine 23:07/2:07/5:07).
...
- Offen beim Betreiber (Stand damals; PostHog und Datenschutz §15 seit
  3.17.23 entfallen): `veroeffentlichen.bat`; am Gerät das Konto-Löschen mit
  Google und die Kalender-Erinnerung auf iOS.
