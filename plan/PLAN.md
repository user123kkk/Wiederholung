...
| ~~14~~ | ~~Analytics – Ja oder Nein?~~ | **Korrektur 24.09.2026, später am Tag: NICHT live.** Der Schlüssel liegt nur auf dem Arbeitszweig, auf `main` ist `POSTHOG_KEY` leer. Vor dem Zusammenführen muss der Betreiber den PostHog-Auftragsverarbeitungsvertrag unterschreiben (gilt nicht automatisch, siehe [`phase-5-recht/PRUEFUNG-2026-09-24.md`](phase-5-recht/PRUEFUNG-2026-09-24.md) R1); die Statistik-Fassung heißt dann 3.17.23, weil `main` ein anderes 3.17.22 hat. — Ursprünglicher Eintrag: **erledigt 24.09.2026 (v3.17.22): JA, live.** Betreiber: „datenschutzerklärung usw. lässt sich umschreiben [...] daher analytics" → gebaut (v3.17.0) → rechtlich geprüft und anwaltlich bestätigt (Betreiber: „mein anwalt sagt dass das alles stimmt") → PostHog-Projekt eingerichtet (EU-Region, Free-Tarif, Autocapture/Session-Replay/Heatmaps aus, IP-Verwerfung an) → `POSTHOG_KEY` eingetragen, veröffentlicht. Dabei entschieden: **Session Replay ausdrücklich nicht aktiviert** (Betreiber-Rückfrage beantwortet, „No, thanks" gewählt) — würde gegen das Versprechen „Nie übertragen werden: der Inhalt deiner Karten" verstoßen und bräuchte eine andere Rechtsgrundlage. Details: [`analytics/GERUEST.md`](analytics/GERUEST.md), [`analytics/INTERESSENABWAEGUNG.md`](analytics/INTERESSENABWAEGUNG.md), `audit/LOGBUCH.md` 24.09.2026. |
